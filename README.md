...
Tables created: **companyName, computer**  
...
Search box can look for either computer or companyName objects.

#### 4.3.8. Add Company deletion feature in cli
In the command line interface, add a feature which deletes a companyName, and all computers related to this companyName. Warning: Using SQL CASCADE is forbidden. This implies the use of a transaction.  
